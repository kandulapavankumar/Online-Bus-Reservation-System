    ...
    <tr>
                ...
                <tr>
                    <td height="50" align="center" bgcolor="#FFFFFF" style="font-family:Verdana, Geneva, sans-serif">
                        <form method="post">
                            ...
                            <br/><br/>
                            <dd>New Password:<font color=#FF0000>*</font> &nbsp;&nbsp;&nbsp;&nbsp; <input
                                    type="password" name="newp" value=""/></dd>
                            <br/><br/>
                            <dd>Confirm Password:<font color=#FF0000>*</font> <input type="password" name="conp"
                                                                                     value=""/></dd>
                            <br/><br/>
                            <?php
                            require("config.php");
		...
		<tr><td><font color=#FF0000 size=2>&nbsp; New Password and Confirm Password are not match &nbsp;</font></td></tr></table>";
                                    ...
                                    if (isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'admin') {
                                        header('location:AdminHome.php?id=$uid');
                                    } else {
